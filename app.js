...
// Your code here
const numsTimes2 = nums.map(num => num * 2);
...
// Your code here
const [firstTopping, secondTopping] = pizzaToppings1;
console.log(`First topping: ${firstTopping}\nSecond topping: ${secondTopping}`);
...
userProfile[propertyName] = "LuisCurielDeSousa";
...
// Your code here
function test(noun = "cat", adjective = "white") {
